...
const remote = new (require('swtc-lib').Remote)({server: mainNetIP, issuer: 'jBciDE8Q3uJjf111VeiUNM775AMKHEbBLS'})
var utility = require("../../test/testUtility.js")
...
remote.connectPromise().then(function(){
    ...
    ///*
    remote.buildPaymentTx({source: address, to: to, amount: remote.makeAmount(0.000001)}).submitPromise(secret, memo).then(function(){
