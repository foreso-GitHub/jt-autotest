...
function rpc() {
    ...
    this.responseSendTx = function (from, secret, to, value, fee, memo) {
        let data = {}
        data.from = from
        data.secret = secret
        data.to = to
    ...
    // this.responseIssueToken = function (from, secret, name, symbol, decimals, total_supply, local, flags) {
    //     let type = 'IssueCoin'
    //     let fee = 10
    //     return this.responseIssueToken(type, from, secret, name, symbol, decimals, total_supply, local, flags, fee)
    // },
