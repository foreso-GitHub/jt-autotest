...
module.exports = tcsSign = {
    ...
    testForSign: function(server, describeTitle){
        ...
        {
            needPass = false
            expectedError = framework.getError(140, 'null from key')
        ...
        {
            needPass = false
            expectedError = framework.getError(-191, 'Unknown secret format')
        ...
        {
            needPass = false
            expectedError = framework.getError(-191, 'Bad Base58 checksum')
