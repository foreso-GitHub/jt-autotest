...
let websocketInterface = require('../framework/lib/ws/websocketInterface')
//endregion
//endregion
...
module.exports = tcsSubscribe = {
    ...
    testForSubscribe: function(server, describeTitle){
        ...
        // }
        //
        // title = '0031\t订阅token: global token'
        // {
        //     let params = ['tx']
        //     testCase = tcsSubscribe.createSingleTestCaseForSubscribe(server, title, params, needPass, expectedError)
        //     testCase.checkFunction = tcsSubscribe.checkForSubscribeTx
        ...
        // }
        //
        // title = '0032\t订阅token: local token'
        // {
        //     let params = ['tx']
        //     testCase = tcsSubscribe.createSingleTestCaseForSubscribe(server, title, params, needPass, expectedError)
        //     testCase.checkFunction = tcsSubscribe.checkForSubscribeTx
    ...
    executeForSubscribe: async function(testCase){
        ...
        return new Promise(async (resolve, reject) => {
            ...
            let realParams = await utility.createTxParams(server, realFrom, realSecret, realTo, value)
            ...
            if(testCase.hasFake && testCase.hasFake == true){
                ...
                let fakeParams = await utility.createTxParams(server, fakeFrom, fakeSecret, fakeTo, value)
    ...
    checkForSubscribeBlock: async function(testCase){
        ...
        expect(blocks.length).to.be.least(3)    //20s, should have 4 blocks
        expect(blocks.length).to.be.most(5)
